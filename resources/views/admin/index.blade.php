        ...
        <div class="row align-items-md-stretch text-center">
            <div class="col-md-4">
                <div class="p-5 bg-body-tertiary border rounded-3">
                    @include('partials.icon', ['class' => 'bi-columns-gap', 'size' => '2'])
            ...
            <div class="col-md-4">
                <div class="p-5 bg-body-tertiary border rounded-3">
                    @include('partials.icon', ['class' => 'bi-sort-down-alt', 'size' => '2'])
            ...
            <div class="col-md-4">
                <div class="p-5 bg-body-tertiary border rounded-3">
                    @include('partials.icon', ['class' => 'bi-droplet-half', 'size' => '2'])
